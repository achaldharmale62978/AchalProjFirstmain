...
const Cmupdate = () => {
    ...
    async function fetchdata() {
        ...
        setValue('bbday', result.data.bbday)
        setValue('genderr', result.data.genderr)
        setValue('bcity', result.data.bcity)
        setValue('bemail', result.data.bemail)
        setValue('bphnum', result.data.bphnum)
        setValue('bpannum', result.data.bpannum)
        setValue('baanum', result.data.baanum)
        setValue('badd', result.data.badd)

        setValue('hname', result.data.hname)
        setValue('sname', result.data.sname)
        setValue('aname', result.data.aname)
        ...
        setValue('honame', result.data.honame)
        setValue('stname', result.data.stname)
        setValue('aaname', result.data.aaname)
        setValue('ciname', result.data.ciname)
        setValue('diname', result.data.diname)
        setValue('st', result.data.st)
        setValue('ziip', result.data.ziip)
