        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid" style={{ fontWeight: 'bold', fontFamily: 'serif', fontSize: '20px' }}>
                    ...
                    <a className="navbar-brand" href="#" style={{ fontSize: '30px' }}>CAR LOAN </a>
                    ...
                    <div className="collapse navbar-collapse nm offset-1" id="navbarSupportedContent">
                        ...
                        <div className=" logn " >
                            <ul class="nav justify-content-end  logn"   >
                                <li className="nav-item  logn" style={{ paddingLeft: '800px', color: 'black' }}  >
            ...
            <nav className=" n3  ">
                ...
                <div className='n1'>
                    <nav class="nav u" >
                        ...
                        <a class="nav-link u1 disabled">Disabled</a>
